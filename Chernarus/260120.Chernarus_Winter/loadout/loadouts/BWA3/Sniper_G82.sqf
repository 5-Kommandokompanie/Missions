...
_unit addPrimaryWeaponItem "BWA3_10Rnd_127x99_G82";
...
_unit addItemToBackpack "BWA3_optic_Hensoldt";
...
for "_i" from 1 to 5 do {_unit addItemToBackpack "BWA3_10Rnd_127x99_G82_Raufoss";};
