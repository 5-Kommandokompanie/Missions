...
_unit addPrimaryWeaponItem "BWA3_200Rnd_556x45";
...
for "_i" from 1 to 5 do {_unit addItemToBackpack "BWA3_200Rnd_556x45";};
for "_i" from 1 to 3 do {_unit addItemToBackpack "BWA3_200Rnd_556x45_Tracer";};
