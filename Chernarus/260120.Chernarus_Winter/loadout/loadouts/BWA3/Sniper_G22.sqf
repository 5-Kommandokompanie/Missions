...
comment "Add weapons";
_unit addWeapon "hlc_rifle_awMagnum_FDE_ghillie";
_unit addPrimaryWeaponItem "hlc_5rnd_300WM_FMJ_AWM";
...
for "_i" from 1 to 14 do {_unit addItemToBackpack "hlc_5rnd_300WM_FMJ_AWM";};
for "_i" from 1 to 5 do {_unit addItemToBackpack "hlc_5rnd_300WM_AP_AWM";};
