...
_unit addVest "KSK_PlateCarrier2_FlecktarnDW_Specialist";
...
for "_i" from 1 to 20 do {_unit addItemToBackpack "rhsusf_5Rnd_Slug";};
for "_i" from 1 to 5 do {_unit addItemToBackpack "BWA3_30Rnd_556x45_G36";};
for "_i" from 1 to 5 do {_unit addItemToBackpack "BWA3_30Rnd_556x45_G36_AP";};
for "_i" from 1 to 5 do {_unit addItemToBackpack "BWA3_30Rnd_556x45_G36_Tracer";};
