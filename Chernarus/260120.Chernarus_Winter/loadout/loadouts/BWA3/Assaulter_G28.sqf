...
_unit addPrimaryWeaponItem "BWA3_20Rnd_762x51_G28";
...
for "_i" from 1 to 8 do {_unit addItemToVest "BWA3_20Rnd_762x51_G28";};
for "_i" from 1 to 3 do {_unit addItemToVest "BWA3_15Rnd_9x19_P8";};
_unit addItemToBackpack "BWA3_muzzle_snds_Rotex_IIA";
_unit addItemToBackpack "BWA3_optic_EOTech_sand_Mag_Off";
...
_unit addItemToBackpack "BWA3_optic_ZO4x30_MicroT2_brown";
for "_i" from 1 to 3 do {_unit addItemToBackpack "BWA3_20Rnd_762x51_G28_Tracer";};
for "_i" from 1 to 3 do {_unit addItemToBackpack "BWA3_20Rnd_762x51_G28_AP";};
for "_i" from 1 to 5 do {_unit addItemToBackpack "BWA3_20Rnd_762x51_G28_SD";};
